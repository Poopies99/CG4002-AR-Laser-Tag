...
def generate_simulated_data():
    ...
    flex1 = random.uniform(0, 1023)
    flex2 = random.uniform(0, 1023)
    return [yaw, pitch, roll, accx, accy, accz, flex1, flex2]


if __name__ == "__main__":
    raw_headers = ["yaw", "pitch", "roll", "ax", "ay", "az", "flex1", "flex2"]
    all_data = []
    ...
    # headers.insert(0, 'timestamp') # inserting timestamp at the beginning of the list

    print("Start")
    try:
        while True:
            # collecting data every 0.05 seconds
            for i in range(20):
            ...
            if 1 == 1:
                ...
                # Add timestamp column to processed data
