...
static float AccErrorX, AccErrorY, AccErrorZ, GyroErrorX, GyroErrorY, GyroErrorZ = 0;
static float AccXSum, AccYSum, AccZSum, GyroXSum, GyroYSum, GyroZSum = 0;
static float AccXAve, AccYAve, AccZAve, GyroXAve, GyroYAve, GyroZAve = 0;
static float prev_GyroXAve, prev_GyroYAve, prev_GyroZAve, prev_AccXAve, prev_AccYAve, prev_AccZAve = 0;
static float GyroXVector, GyroYVector, GyroZVector, AccXVector, AccYVector, AccZVector = 0;
...
static uint8_t serial_buffer[PACKET_SIZE];
static BLEPacket* curr_packet;

static BLEPacket default_packets[3];
